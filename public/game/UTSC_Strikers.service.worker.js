...
/** @type {string} */
const CACHE_VERSION = '1764718424|59197322';
/** @type {string} */
const CACHE_PREFIX = 'UTSC Strikers-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'UTSC_Strikers.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["UTSC_Strikers.html","UTSC_Strikers.js","UTSC_Strikers.offline.html","UTSC_Strikers.icon.png","UTSC_Strikers.apple-touch-icon.png","UTSC_Strikers.audio.worklet.js","UTSC_Strikers.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["UTSC_Strikers.wasm","UTSC_Strikers.pck"];
